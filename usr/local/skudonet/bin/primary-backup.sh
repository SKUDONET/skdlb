...
#
#    Copyright (C) 2023-today SKUDONET SL, Sevilla (Spain)
#
...
case "$1" in
  ...
  backup)
    ...
    #
    # SKUDONET: -t implies a scheduled flush but not time controlled
    # let the conntrack with zombies entries is not a problem
