...
#### OPTIONS requests ################################################
require Skudonet::API31::Routes::Options  if ( $ENV{ REQUEST_METHOD } eq 'OPTIONS' );

##### Authentication #################################################
require Skudonet::API31::Auth;
require Skudonet::Zapi;

# Session request
require Skudonet::API31::Routes::Session if ( $q->path_info eq '/session' );
