...
#### OPTIONS requests ################################################
require Skudonet::API40::Options if ( $ENV{ REQUEST_METHOD } eq 'OPTIONS' );

##### Authentication #################################################
require Skudonet::API40::Auth;
require Skudonet::Zapi;

# Session request
require Skudonet::API40::Session if ( $q->path_info eq '/session' );
