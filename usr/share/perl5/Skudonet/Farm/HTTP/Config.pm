...
Function: getHTTPFarmBootStatus
	...
	Return the farm status at boot skudonet
...
Function: setHTTPFarmBootStatus
	...
	Set the farm status in the configuration file to boot skudonet process
...
Parameters:
	farmname - Farm name
	ng_proxy - It is used to set the log parameter depending on the zproxy or pound. It is termporary, it should disappear when pound will be removed from Skudonet
...
Function: migrateHTTPFarmLogs
	...
	This function is temporary. It is used while zproxy and pound are available in skudonet.
