...
sub setOldFarmguardian
{
	...
	my $def = {
		'description' =>
		  "This farmguardian was created automatically to migrate to Skudonet 5.2 version or higher",
		'command'   => $obj->{ command },
		'log'       => $obj->{ log },
...
See Also:
	zcluster-manager, skudonet, <runFarmStart>, <setNewFarmName>, zapi/v3/farm_guardian.cgi, zapi/v2/farm_guardian.cgi
=cut
...
See Also:
	skudonet, <runFarmStop>, <setNewFarmName>, zapi/v3/farm_guardian.cgi, <runFarmGuardianRemove>
=cut
