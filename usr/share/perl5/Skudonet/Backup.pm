...
sub applyBackup
{
	...
	$error = &logAndRun( "/etc/init.d/skudonet start" );
...
Function: getBackupVersion
	...
	It gets the version of skudonet from which the backup was created

Parameters:
	backup - Backup name.

Returns:
	String - Skudonet version
